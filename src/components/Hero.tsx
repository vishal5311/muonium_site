...
const Hero = () => {
    ...
    return (
        <header className="relative w-full h-screen overflow-hidden bg-black font-sans selection:bg-white/20">
            ...
            <div className={`absolute inset-0 w-full h-full z-0 select-none pointer-events-none overflow-hidden transition-opacity duration-1000 ${videoLoaded ? 'opacity-40' : 'opacity-0'}`}>
